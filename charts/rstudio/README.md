...
> The aim of this Helm chart is to give an easy and straightforward way to deploy RStudio on OpenShift and Kubernetes clusters. Currently the chart is mostly optimized and used in OpenShift/OKD clusters, if you are using it with other Kubernetes distributions please let us know  in the [GitHub repository issues](https://github.com/nocsyshelmrepo/dsri-helm-charts/issues), we would love to hear about it!
...
> Visit the [dsri-helm-charts GitHub repository](https://github.com/nocsyshelmrepo/dsri-helm-charts) for more details on how to develop and tests the charts, feel free to send us pull requests to propose your improvements!
